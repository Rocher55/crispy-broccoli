...
public class ModeleP4 {
     ...
     */
    //
    public void jouer(CouleurP4 c, int j) throws IllegalArgumentException {
        if (this.etat != 0) {
        ...
        if (c == CouleurP4.VIDE) {
            throw new IllegalArgumentException("couleur du pion invalide");
        }
        if (this.grille[0][j] != CouleurP4.VIDE) {
     ...
     *                invalide
     */
    public CouleurP4 getCouleur(int i, int j) throws IllegalArgumentException {
        if (i < 0 || i >= 6) {
